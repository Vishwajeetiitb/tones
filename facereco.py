...
###############################Family##########################
vishwajeet_image = face_recognition.load_image_file("vishwajeet.jpg")
vishwajeet_face_encoding = face_recognition.face_encodings(vishwajeet_image)[0]

mrunali_image = face_recognition.load_image_file("mrunali.jpg")
mrunali_face_encoding = face_recognition.face_encodings(mrunali_image)[0]
